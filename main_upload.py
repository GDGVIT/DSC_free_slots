...
def main(folderAddress):
    ...
    for filename in files:
        #    this will extract the slotNumbers from the screenshots and
        #    save it in slotNumbers.txt in json format
        convertImage2json(filename)
    #      Convert the self defined free slot numbers , into Day and Time
    #      details and store it in day&time.txt in json
    convertSlotToTime()
